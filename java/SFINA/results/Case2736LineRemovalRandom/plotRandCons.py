...
plt.legend((line1, line2, line3),('Matpower DC','InterPSS DC','Link Loss'), loc='best', fontsize=16, labelspacing=0.15, borderpad=0.3, handletextpad=0.15)
ax.tick_params(axis='both',length=6, width=1)
ax2.tick_params(axis='both',length=6, width=1)
ax.set_ylabel('Power Loss [%]')
ax.set_xlabel('Attacked Links [%]')
#plt.xlim(0,73)
