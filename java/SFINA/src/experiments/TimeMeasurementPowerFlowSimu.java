 ...
 */
public class TimeMeasurementPowerFlowSimu extends SimulatedExperiment{
    ...
    private final static int runDuration=24;
    ...
    public static void main(String[] args) {
        ...
        final TimeMeasurementPowerFlowSimu test = new TimeMeasurementPowerFlowSimu();
        test.init();
