...
public class SimulationAgentNew extends BasePeerlet implements SimulationAgentInterfaceNew{
    ...
    */
    ...
    public void runBootstraping(){
        ...
        loadAgentTimer.addTimerListener(new TimerListener(){
            public void timerExpired(Timer timer){
                ...
                topologyLoader=new TopologyLoader(flowNetwork, columnSeparator, getPeer().getNetworkAddress());
                ...
                initializeInterdependentNetwork();
    ...
    /**
     * Bootstraping method for interdependent implementation. 
     */
