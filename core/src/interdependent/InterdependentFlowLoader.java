 ...
 */
public class InterdependentFlowLoader {
    ...
    public InterdependentFlowLoader(FlowNetwork net, String parameterValueSeparator, String missingValue, FlowNetworkDataTypesInterface flowNetworkDataTypes){
        this.net=net;
