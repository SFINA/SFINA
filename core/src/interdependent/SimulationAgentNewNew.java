...
// * @author root
// */
//public class SimulationAgentNewNew extends BasePeerlet implements SimulationAgentInterface, CommunicationAgentInterface.MessageReceiver{
//    
...
//        
//        //new because Ben
//        topologyLoader=new TopologyLoader(flowNetwork, getCommunicationAgent().getColumnSeparator(), getNetworkIndex());
//        
//        //topologyLoader=new TopologyLoader(flowNetwork, );
...
//         
//         topologyWriter = new TopologyWriter(flowNetwork, getCommunicationAgent().getColumnSeparator(), getNetworkIndex());
