...
//        if (this.getSimulationTime()<getFlowNetwork().getLinks().size()+1){
//            Link link = getFlowNetwork().getLink(Integer.toString(this.getSimulationTime()));
    ...
    private boolean setGenerationArray(FlowNetwork flowNetwork){
        ...
        if (slack == null){
            if (generators.size() == 0){
                ...
                converged = false; // blackout if no generator in island
            }
